<template>
    <v-dialog content-class="modal-register" v-model="showVerifyAccount">
        <v-card class="modal-register-card">
            <v-card-title class="text-xs-left justify-left title mb-2">
            ...
            <div class="pa-5 border overflow-hidden shadow-light">
                <p>
                    Digite su correo y el codigo de verificacion que le hemos enviado para poder verficar la cuenta
                </p>
                <!-- <div
                    v-if="
                        authSettings.customer_login_with == 'email' ||
                        (authSettings.customer_login_with == 'email_phone' && authSettings.customer_otp_with == 'email')
                    "
                ...
                <div
                    v-else-if="
                        ...
                        (authSettings.customer_login_with == 'email_phone' && authSettings.customer_otp_with == 'phone')
                    "
                    class="info--text mb-3"
                >
