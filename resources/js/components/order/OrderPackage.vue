<template>
    <div style="background-color: #fafcfc;">
        ...
        <div class="my-5">
            ...
            <v-row>
                <v-col cols="6" sm="8" class="py-1 d-flex justify-start justify-sm-end align-center">
            ...
            <v-row>
                <v-col cols="0" sm="8" class="py-1 d-flex justify-start justify-sm-end align-center">
