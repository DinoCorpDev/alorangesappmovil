            ...
            <template v-if="!isLoading">
                ...
                <div class="d-flex fs-12">
                    ...
                    <span class="ms-3 opacity-50">
                        ({{ productDetails.review_summary.total_count }} {{ $t("ratings") }})
                    </span>

                    <!-- todo:: message seller -->
                    <div
                        v-if="generalSettings.conversation_system == 1 && is_addon_activated('multi_vendor')"
                        class="ms-auto"
                    >
                        <button
                ...
                <div v-if="productDetails.is_variant == 1" class="border-top mt-4">
                    <v-row v-for="(variation_option, i) in productDetails.variation_options" :key="i" class="mt-4">
                        <v-col cols="3" lg="2" class="py-2">
