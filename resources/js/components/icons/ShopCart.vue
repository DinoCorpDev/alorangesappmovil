<template>
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        <g transform="translate(2.002 1.978)">
            <circle cx="1.502" cy="1.502" r="1.502" transform="translate(6.507 17.017)" fill="currentColor" />
            <circle cx="1.502" cy="1.502" r="1.502" transform="translate(17.017 16.989)" fill="currentColor" />
            <path
