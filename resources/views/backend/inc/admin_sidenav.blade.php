    ...
    <div class="aiz-sidebar left c-scrollbar">
        <div class="aiz-side-nav-logo-wrap">
            <a href="{{ route('admin.dashboard') }}" class="d-block text-left">
                ...
                @else
                    <img class="mw-100" src="{{ static_asset('assets/img/logo-white.png') }}" class="brand-icon"
                        alt="{{ get_setting('site_name') }}">
                @endif
            </a>
        </div>
        ...
        <div class="aiz-side-nav-wrap">
            <ul class="aiz-side-nav-list" data-toggle="aiz-side-menu">
                ...
                <!-- Product -->
                @canany(['show_products', 'show_seller_products', 'show_services', 'show_categories', 'show_brands',
                    'show_attributes', 'show_reviews'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                            ...
                            <span class="aiz-side-nav-text">{{ translate('Items') }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <!--Submenu-->
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @can('show_products')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('service.index') }}"
                                        ...
                                        <span class="aiz-side-nav-text">
                                            {{ addon_is_activated('multi_vendor') ? translate('Inhouse Services') : translate('Services') }}
                                        </span>
                                    </a>
                                </li>
                            @endcan
                ...
                <!-- Order -->
                @if (addon_is_activated('multi_vendor') &&
                        (auth()->user()->can('show_orders') ||
                            auth()->user()->can('show_seller_orders')))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                        ...
                        <a href="{{ route('customers.index') }}"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="14" viewBox="0 0 16 14">
                                <g id="Group_8860" data-name="Group 8860" transform="translate(30 -252)">
                                    ...
                                    <circle id="Ellipse_612" data-name="Ellipse 612" cx="3" cy="3"
                                        r="3" transform="translate(-28 252)" fill="#707070" />
                ...
                @if (addon_is_activated('multi_vendor'))
                    @canany(['show_sellers', 'show_payouts', 'show_payout_requests', 'show_commission_log',
                        'show_seller_packages', 'show_seller_package_payments'])
                        <li class="aiz-side-nav-item">
                            <a href="#" class="aiz-side-nav-link">
