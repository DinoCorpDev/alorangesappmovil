...
@section('content')
    <div class="aiz-titlebar text-left mt-2 mb-3">
        <h1 class="mb-0 h6">Editar Plan</h5>
    </div>
    <form class="form form-horizontal mar-top" id="product_form" action="{{ route('plans.update', $plan->id) }}"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" name="referencia" type="text"
                                    placeholder="Referencia"  value="{{ $plan->referencia }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" name="nombre" type="text"
                                    placeholder="Nombre" value="{{ $plan->nombre }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control"  value="{{ $plan->precio }}" name="precio" type="number" value="1" step="0.01" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea name="descripcion" class="form-control" id="" cols="30" rows="10" required>{{ $plan->descripcion }}</textarea>
                            </div>
                        </div>

                        <div class="form-group row">
                            <button class="btn btn-primary" id="upload-product"
                                type="submit">Actualizar Plan</button>
                        </div>
