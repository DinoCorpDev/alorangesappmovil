        ...
        <div class="col-2">
            <div class="dropdown float-right">
                ...
                >
                    <a
                        class="dropdown-item"
                        href="{{ route('order.status', ['order_id' => $order->id, 'status' => '1']) }}"
                    >
                        Contabilidad
                    </a>
                    <a
                        class="dropdown-item"
                        href="{{ route('order.status', ['order_id' => $order->id, 'status' => '2']) }}"
                    >
                        Despacho
                    </a>
                    <a
                        class="dropdown-item"
                        href="{{ route('order.status', ['order_id' => $order->id, 'status' => '3']) }}"
                    >
                        Entregada
                    </a>
                </div>
