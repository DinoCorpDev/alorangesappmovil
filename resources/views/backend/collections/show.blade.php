        ...
        <div class="card-body">
            <div class="row align-items-center">
                <div class="col-lg-auto">
                    <img class="size-200px" src="{{ uploaded_asset($collection->imagen1) }}">
                </div>
                <div class="col-lg">
                    <h1 class="h5 fw-700">
                        {{ $collection->coleccion }}
                        <a class="btn btn-success mb-0 float-right" for="openCSV"
                    ...
                    <div class="mb-3 d-flex justify-content-between">
                        ...
                        <span class="text-right">
                            @if ($collection->categoria)
                                ...
                                @endphp
                                <span class="badge badge-inline badge-md bg-soft-dark mb-1">{{ $ca->name }}</span>
                            @endif
                            ...
                            @if ($collection->subcategoria)
                                ...
                                @endphp
                                <span class="badge badge-inline badge-md bg-soft-dark mb-1">{{ $sub->name }}</span>
                            @endif
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input class="form-control" name="precio" type="text" value="{{ $collection->precio }}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input class="form-control" name="width" type="text" value="{{ $collection->divisa }}"
                                min="0" required readonly />
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input class="form-control" name="width" type="text" value="{{ $collection->envio }}"
                                min="0" required readonly />
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group row mt-5">
                        ...
                        <div class="col-md-8">
                            <input class="form-control" name="width" type="text" value="{{ $collection->material }}"
                                min="0" required readonly />
                        </div>
                    </div>
                    ...
                    <div class="form-group row mt-5">
                        ...
                        <div class="col-md-8">
                            <input class="form-control" name="width" type="text"
                                value="{{ $collection->medida_de_proyecto }}" min="0" required readonly />
                        </div>
                    </div>
                    ...
                    <div class="form-group row mt-5">
                        ...
                        <div class="col-md-8">
                            <input class="form-control" name="width" type="text" value="{{ $collection->si1 }}"
                                min="0" required readonly />
                        </div>
                    </div>
                    ...
                    <div class="form-group row mt-5">
                        ...
                        <div class="col-md-8">
                            <input class="form-control" name="width" type="text" value="{{ $collection->aforo }}"
                                min="0" required readonly />
                        </div>
                    </div>
                    ...
                    <div class="form-group row mt-5">
                        ...
                        <div class="col-md-8">
                            <input class="form-control" name="width" type="text"
                                value="{{ $collection->postventa }}" min="0" required readonly />
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <div class="input-group" data-toggle="aizuploader" data-type="image">
                                ...
                                <input class="selected-files" name="imagen1" type="hidden"
                                    value="{{ $collection->imagen1 }}" required readonly>
                            </div>
