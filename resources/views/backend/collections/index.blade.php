        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-3 offset-md-2 text-md-right">
                @can('add_products')
                    ...
                    <form class="d-none" id="formCSV" action="{{ route('collection.import') }}" method="post"
                                ...
                                <a class="text-reset d-block" href="{{ route('collection', $collection->slug) }}"
                                    ...
                                    <div class="d-flex align-items-center">
                                        <img class="size-60px size-xxl-80px mr-2"
                                            src="{{ uploaded_asset($collection->imagen1) }}" alt="Image"
                            ...
                            <td class="text-right">
                                ...
                                @can('delete_products')
                                    <a class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete"
                                        data-href="{{ route('collection.destroy', $collection->id) }}" href="#"
