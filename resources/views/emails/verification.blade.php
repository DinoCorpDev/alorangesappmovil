													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														...
														@if($array['subject'] == 'Email Verification')
															<td class="center pb10" style="text-align:center; padding-bottom:10px;">
																<a class="h2 center pb10" style="color:#000000; font-family:'Ubuntu', Arial,sans-serif; font-size:30px; line-height:60px; " href="{{ url('/?modal=VerifyAccount') }}">Link verify account</a>
															</td>
														@endif
                                                        @if(!empty( $array['link']))
                                                            <tr>
