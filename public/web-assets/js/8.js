...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapActions"])("cart", ["addToCart", "updateQuantity"])), {}, {
          ...
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _this.addToCart({
                ...
                variation_id: _this.data.id,
                qty: 1
              });
              _this.snack({
                message: _this.$i18n.t("product_added_to_cart"),
                color: "green"
              });
            case 2:
            case "end":
