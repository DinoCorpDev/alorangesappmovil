...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapGetters"])("app", ["generalSettings", "availableCountries"])), {}, {
    ...
    postalCodeErros: function postalCodeErros() {
      var errors = [];
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                if (!(_this.$v.form.$anyError || _this.$v.mainAddress.$anyError)) {
                  _context.next = 7;
                  break;
                }
                return _context.abrupt("return");
              case 7:
                ...
                _this.mainAddress.phone = _this.form.phone;
                _this.loading = true;
                _context.next = 12;
              ...
              case 12:
                ...
                _this.mainAddress.customer_id = res.data.user.id;
                _context.next = 17;
                return _this.saveAddress().then(function () {
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _this5.mainAddress.phone = _this5.form.phone;
                _context5.prev = 1;
                _context5.next = 4;
                return _this5.call_api("post", "user/address/create", _this5.mainAddress);
              case 4:
                res = _context5.sent;
                if (!res.data.success) {
                  _context5.next = 9;
...
var render = function render() {
  ...
  return _c("div", {
    ...
    on: {
      blur: function blur($event) {
        return _vm.$v.mainAddress.name.$touch();
      }
    },
    model: {
      value: _vm.mainAddress.name,
      callback: function callback($$v) {
        _vm.$set(_vm.mainAddress, "name", $$v);
      },
      expression: "mainAddress.name"
    }
  })], 1), _vm._v(" "), _c("v-col", {
    attrs: {
      cols: "12",
    ...
    on: {
      blur: function blur($event) {
        return _vm.$v.mainAddress.address.$touch();
      }
    },
    model: {
      value: _vm.mainAddress.address,
      callback: function callback($$v) {
        _vm.$set(_vm.mainAddress, "address", $$v);
      },
      expression: "mainAddress.address"
    }
  })], 1)], 1)], 1), _vm._v(" "), _c("v-col", {
    attrs: {
      cols: "12",
    ...
    on: {
      blur: function blur($event) {
        return _vm.$v.mainAddress.details.$touch();
      }
    },
    model: {
      value: _vm.mainAddress.details,
      callback: function callback($$v) {
        _vm.$set(_vm.mainAddress, "details", $$v);
      },
      expression: "mainAddress.details"
    }
  })], 1)], 1), _vm._v(" "), _c("v-row", [_c("v-col", {
    attrs: {
      cols: "12",
    ...
    attrs: {
      "error-messages": _vm.postalCodeErros,
      required: ""
    },
    on: {
      blur: function blur($event) {
        return _vm.$v.mainAddress.postal_code.$touch();
      }
    },
    model: {
      value: _vm.mainAddress.postal_code,
      callback: function callback($$v) {
        _vm.$set(_vm.mainAddress, "postal_code", $$v);
      },
      expression: "mainAddress.postal_code"
    }
  })], 1), _vm._v(" "), _c("v-col", {
    attrs: {
      cols: "12",
    ...
    on: {
      blur: function blur($event) {
        return _vm.$v.mainAddress.state.$touch();
      },
      input: _vm.stateChanged
    },
    model: {
      value: _vm.mainAddress.state,
      callback: function callback($$v) {
        _vm.$set(_vm.mainAddress, "state", $$v);
      },
      expression: "mainAddress.state"
    }
  })], 1)], 1), _vm._v(" "), _c("v-row", [_c("v-col", {
    attrs: {
      cols: "12",
    ...
    on: {
      blur: function blur($event) {
        return _vm.$v.mainAddress.city.$touch();
      }
    },
    model: {
      value: _vm.mainAddress.city,
      callback: function callback($$v) {
        _vm.$set(_vm.mainAddress, "city", $$v);
      },
      expression: "mainAddress.city"
    }
  })], 1), _vm._v(" "), _c("v-col", {
    attrs: {
      cols: "12",
    ...
    model: {
      value: _vm.mainAddress.neighborhood,
      callback: function callback($$v) {
        _vm.$set(_vm.mainAddress, "neighborhood", $$v);
      },
      expression: "mainAddress.neighborhood"
    }
  })], 1)], 1), _vm._v(" "), _c("v-row", [_c("v-col", {
    attrs: {
      cols: "12",
    ...
    on: {
      blur: function blur($event) {
        return _vm.$v.mainAddress.country.$touch();
      },
      input: _vm.countryChanged
    },
    model: {
      value: _vm.mainAddress.country,
      callback: function callback($$v) {
        _vm.$set(_vm.mainAddress, "country", $$v);
      },
      expression: "mainAddress.country"
    }
  })], 1), _vm._v(" "), _c("v-col", {
    attrs: {
      cols: "12",
