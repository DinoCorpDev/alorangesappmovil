...
Route::group([
    ...
    //coupons
    Route::resource('coupons', CouponController::class)->names('coupons')->except(['destroy']);
...
Route::group([
    ...
    // Seller package
    Route::resource('seller-packages', AdminSellerPackageController::class)->names('seller_packages')->except(['edit', 'destroy']);
